#+TITLE: Manual testing steps for org-cockpit
#+STARTUP: showall

These are manual tests to be done for each org-cockpit steps.
...
- org-cockpit insert/table/table
...
- org-cockpit insert/table/import
...
** Can be applied to words
   Check that the word bar can be marked, and then made bold from the org-cockpit
...
** Can be removed
   ...
   Marking either "*bar*" or "bar" in this text, then open org-cockpit, press *
...
[[file:~/Development/org-cockpit/org-cockpit.el][Source!]]
